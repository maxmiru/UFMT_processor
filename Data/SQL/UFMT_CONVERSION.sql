...
Insert into UFMT_CONVERSION ( CONV_KEY, CONV_TYPE, DESCRIPTION ) Values ( '90','0','COND CONV: iBSM FT-related trans_types' );
...
Insert into UFMT_CONVERSION ( CONV_KEY, CONV_TYPE, DESCRIPTION ) Values ( '143','0','iBSM mapping for F63' );
Insert into UFMT_CONVERSION ( CONV_KEY, CONV_TYPE, DESCRIPTION ) Values ( '144','0','iBSM mapping for F104' );
Insert into UFMT_CONVERSION ( CONV_KEY, CONV_TYPE, DESCRIPTION ) Values ( '145','0','iBSM mapping for F125' );
Insert into UFMT_CONVERSION ( CONV_KEY, CONV_TYPE, DESCRIPTION ) Values ( '146','0','iBSM mapping for F126' );
Insert into UFMT_CONVERSION ( CONV_KEY, CONV_TYPE, DESCRIPTION ) Values ( '147','0','iBSM mapping for F127' );
Insert into UFMT_CONVERSION ( CONV_KEY, CONV_TYPE, DESCRIPTION ) Values ( '148','4','Multiple x 100' );
Insert into UFMT_CONVERSION ( CONV_KEY, CONV_TYPE, DESCRIPTION ) Values ( '149','4','Divided by 100' );
Insert into UFMT_CONVERSION ( CONV_KEY, CONV_TYPE, DESCRIPTION ) Values ( '150','2','iBSM F48 -> ACCT2_OPEN' );
Insert into UFMT_CONVERSION ( CONV_KEY, CONV_TYPE, DESCRIPTION ) Values ( '151','0','Set to resp 914' );
Insert into UFMT_CONVERSION ( CONV_KEY, CONV_TYPE, DESCRIPTION ) Values ( '152','0','Xlink trans_type->F70' );
Insert into UFMT_CONVERSION ( CONV_KEY, CONV_TYPE, DESCRIPTION ) Values ( '153','0','COND CONV: iBSM FT trans_types' );
Insert into UFMT_CONVERSION ( CONV_KEY, CONV_TYPE, DESCRIPTION ) Values ( '154','5','Cust func get_original_value' );
Insert into UFMT_CONVERSION ( CONV_KEY, CONV_TYPE, DESCRIPTION ) Values ( '155','2','CMS-TRX ProcCode->TT (1st 2 digits)' );
Insert into UFMT_CONVERSION ( CONV_KEY, CONV_TYPE, DESCRIPTION ) Values ( '156','0','CMS-TRX ProcCode->TT (mapping)' );
Insert into UFMT_CONVERSION ( CONV_KEY, CONV_TYPE, DESCRIPTION ) Values ( '157','0','CMS-TRX BankCode->BankID' );
Insert into UFMT_CONVERSION ( CONV_KEY, CONV_TYPE, DESCRIPTION ) Values ( '158','0','CMS-TRX default TID' );
Insert into UFMT_CONVERSION ( CONV_KEY, CONV_TYPE, DESCRIPTION ) Values ( '159','0','CMS-TRX default MID' );
Insert into UFMT_CONVERSION ( CONV_KEY, CONV_TYPE, DESCRIPTION ) Values ( '160','5','Cust func get_hpan_by_acct' );
Insert into UFMT_CONVERSION ( CONV_KEY, CONV_TYPE, DESCRIPTION ) Values ( '161','4','Set HPAN1 from Acct1' );
Insert into UFMT_CONVERSION ( CONV_KEY, CONV_TYPE, DESCRIPTION ) Values ( '162','4','Set HPAN2 from Acct2' );
Insert into UFMT_CONVERSION ( CONV_KEY, CONV_TYPE, DESCRIPTION ) Values ( '163','4','Set CMS-TRX resp msgtype' );
Insert into UFMT_CONVERSION ( CONV_KEY, CONV_TYPE, DESCRIPTION ) Values ( '164','0','SV resp->CMS-TRX status' );
